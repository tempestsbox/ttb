...
#relic
execute if entity @s[predicate=ttb:entity/function/holding/bright_relic] run function ttb:entity/function/holding/bright_relic
execute if entity @s[predicate=ttb:entity/function/holding/dark_relic] run function ttb:entity/function/holding/dark_relic
