...
execute if score @s ttb_relic_damage >= $threshold ttb_relic_damage if entity @s[nbt={SelectedItem:{tag:{ttb:{item:"staff"}}}}] if score @s ttb_staff_dur < @s ttb_staff_durmax run function ttb:item/staff/durability/recharge/bright_relic
