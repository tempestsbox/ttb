...
#debug
execute if entity @s[tag=ttb_debug] if entity @e[tag=ttb_entity,limit=1] run title @s actionbar [{"text":"","color":"red"},[{"nbt":"ArmorItems[3].tag.CustomModelData","entity":"@e[tag=ttb_entity,tag=ttb_dynamic_model,sort=nearest,limit=1]"}," ",{"nbt":"HurtTime","entity":"@e[tag=ttb_entity,tag=ttb_dynamic_model,sort=nearest,limit=1]"}," ",{"nbt":"Health","entity":"@e[tag=ttb_entity,sort=nearest,limit=1]"}," ",{"nbt":"Tags","entity":"@e[tag=ttb_entity,sort=nearest,limit=1]"}]]
