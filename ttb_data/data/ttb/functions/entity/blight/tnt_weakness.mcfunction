...
execute at @s run summon creeper ~ ~ ~ {Fuse:0s,CustomName:'[{"translate":"block.minecraft.tnt"},{"translate":"text.ttb.entity.whilst_fighting"},{"translate":"entity.ttb.blight"}]',ExplosionRadius:1b,Tags:["ttb_no_check"]}
