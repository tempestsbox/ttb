...
# abilities
execute if predicate ttb:entity/blight/attack/random_chance if entity @a[distance=..8,gamemode=!creative,gamemode=!spectator,limit=1] run function ttb:entity/blight/ability_check
