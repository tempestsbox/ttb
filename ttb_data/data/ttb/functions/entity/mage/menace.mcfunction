...
effect give @e[type=#ttb:entity/mage/menace,distance=..12] speed 10 1
effect give @e[type=#ttb:entity/mage/menace,distance=..12] resistance 10 1
fill ~1 ~1 ~1 ~-1 ~-1 ~-1 air replace #ttb:torches

execute at @e[type=#ttb:entity/mage/menace,distance=..12] run particle angry_villager ~ ~ ~ 1 1 1 0.01 10 normal @a
