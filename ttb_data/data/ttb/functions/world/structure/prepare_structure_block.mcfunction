setblock ~ ~ ~ structure_block{ignoreEntities:1b,showboundingbox:1b,posY:0,mode:"LOAD"}
...
execute if data storage ttb:world structure.dungeon.get_room_result[0].shift_y store result block ~ ~ ~ posY int 1 run data get storage ttb:world structure.dungeon.get_room_result[0].shift_y -1
