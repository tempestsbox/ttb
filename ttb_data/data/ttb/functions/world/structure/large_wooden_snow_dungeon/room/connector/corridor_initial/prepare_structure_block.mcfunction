data modify storage ttb:temp world.structure.room.type.id set value "ttb:world/structure/large_wooden_snow_dungeon/function/room/connector/corridor_initial"
