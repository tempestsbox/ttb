...
execute if data storage ttb:world structure.spawns[0].id at @s run function ttb:world/structure/spawn_id
...
data remove storage ttb:world structure.spawns[0]
execute if data storage ttb:world structure.spawns[0] run function ttb:world/structure/loop_spawns
