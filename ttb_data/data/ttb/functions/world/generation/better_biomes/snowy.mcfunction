...
fill ~ 0 ~ ~15 127 ~15 snow[layers=3] replace #small_flowers
...
fill ~ 0 ~ ~15 127 ~15 light_gray_concrete_powder replace gravel
fill ~ 0 ~ ~15 127 ~15 water replace lava

fill ~ 128 ~ ~15 255 ~15 snow[layers=2] replace grass
fill ~ 128 ~ ~15 255 ~15 snow[layers=3] replace #small_flowers
