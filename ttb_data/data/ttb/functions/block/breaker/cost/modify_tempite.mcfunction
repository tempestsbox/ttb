...
scoreboard players operation @s ttb_ascended *= $cost_breaker_ascended ttb_tempite_amnt
scoreboard players operation @s ttb_tempite_amnt -= @s ttb_ascended
scoreboard players operation @s ttb_reduced *= $cost_breaker_reduced ttb_tempite_amnt
