...
execute if block ~ ~ ~ pink_terracotta run loot spawn ~ ~ ~ loot ttb:items/amethyst_sunpad
fill ~ ~ ~ ~ ~ ~ pink_terracotta replace #ttb:replace_on_creation
execute unless block ~ ~ ~ pink_terracotta run loot spawn ~ ~ ~ loot ttb:items/amethyst_sunpad
