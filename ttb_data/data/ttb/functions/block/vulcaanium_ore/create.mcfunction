...
#create vulcaanium ore
execute if block ~ ~ ~ spawner{SpawnData:{ArmorItems:[{tag:{ttb:{item:"vulcaanium_ore"}}}]}} run loot spawn ~ ~ ~ loot ttb:items/vulcaanium_ore
fill ~ ~ ~ ~ ~ ~ spawner{SpawnData:{id:armor_stand,ArmorItems:[{},{},{},{id:spawner,Count:1,tag:{ttb:{item:"vulcaanium_ore"},CustomModelData:6830002}}]}} replace #ttb:block/replace_on_creation
