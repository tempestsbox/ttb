...
#reimburse items
execute align xyz if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:dropper",tag:{display:{Name:'{"translate":"block.ttb.tempest_crafter"}'}}}}] run loot spawn ~ ~ ~ loot ttb:blocks/tempest_crafter
