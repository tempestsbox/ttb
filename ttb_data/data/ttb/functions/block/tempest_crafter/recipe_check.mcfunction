...
#staff random recipe
execute if score @s ttb_slot_count matches 7 if score @s ttb_slot_size matches ..1 if block ~ ~ ~ barrel{Items:[{id:"minecraft:diamond",Slot:2b},{id:"minecraft:ender_eye",Slot:3b},{id:"minecraft:diamond",Slot:2b},{id:"minecraft:diamond",Slot:4b},{id:"minecraft:blaze_rod",Slot:12b},{id:"minecraft:diamond",Slot:13b},{id:"minecraft:blaze_rod",Slot:21b}]} run function ttb:item/staff/craft_random
