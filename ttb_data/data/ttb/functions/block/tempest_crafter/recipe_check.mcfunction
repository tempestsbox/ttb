...
# eckspei locker
execute if score @s ttb_slot_count matches 9 if score @s ttb_slot_size matches 1 if block ~ ~ ~ barrel{Items:[{Slot:9b,tag:{ttb:{item:'vulcaanium'}},Count:1b} ,{Slot:1b,tag:{ttb:{crafting:{input:[{id:'minecraft:iron_ingot',Slot:0b},{id:'minecraft:iron_ingot',Slot:1b},{id:'minecraft:iron_ingot',Slot:2b},{id:'minecraft:glass_pane',Slot:3b},{id:'minecraft:glass_bottle',Slot:4b},{id:'minecraft:glass_pane',Slot:5b},{id:'minecraft:iron_ingot',Slot:6b},{id:'minecraft:hopper',Slot:7b},{id:'minecraft:iron_ingot',Slot:8b}]}}}}]} run function ttb:block/eckspei_locker/craft
