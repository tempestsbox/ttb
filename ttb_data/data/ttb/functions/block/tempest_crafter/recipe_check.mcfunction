...
# breaker
execute if score @s ttb_slot_count matches 9 if score @s ttb_slot_size matches 1 if data storage ttb:temp block.tempest_crafter{input:[{id:'minecraft:red_nether_bricks',Slot:0b},{id:'minecraft:red_nether_bricks',Slot:1b},{id:'minecraft:red_nether_bricks',Slot:2b},{id:'minecraft:red_nether_bricks',Slot:3b},{id:'minecraft:lava_bucket',Slot:4b},{id:'minecraft:iron_bars',Slot:5b},{id:'minecraft:red_nether_bricks',Slot:6b},{id:'minecraft:red_nether_bricks',Slot:7b},{id:'minecraft:red_nether_bricks',Slot:8b},{Slot:9b,tag:{ttb:{item:'vulcaanium'}},Count:4b}]} run function ttb:block/breaker/craft
# acronite cage
execute if score @s ttb_slot_count matches 9 if score @s ttb_slot_size matches ..64 if data storage ttb:temp block.tempest_crafter{input:[{id:'minecraft:blackstone',Slot:0b},{id:'minecraft:blackstone',Slot:1b},{id:'minecraft:blackstone',Slot:2b},{id:'minecraft:blackstone',Slot:3b},{id:'minecraft:dispenser',Slot:4b},{id:'minecraft:iron_bars',Slot:5b},{id:'minecraft:blackstone',Slot:6b},{id:'minecraft:blackstone',Slot:7b},{id:'minecraft:blackstone',Slot:8b},{Slot:9b,tag:{ttb:{item:'vulcaanium'}},Count:2b}]} run function ttb:block/acronite_cage/craft
# eckspei locker
execute if score @s ttb_slot_count matches 9 if score @s ttb_slot_size matches ..64 if data storage ttb:temp block.tempest_crafter{input:[{id:'minecraft:iron_ingot',Slot:0b},{id:'minecraft:iron_ingot',Slot:1b},{id:'minecraft:iron_ingot',Slot:2b},{id:'minecraft:glass_pane',Slot:3b},{id:'minecraft:glass_bottle',Slot:4b},{id:'minecraft:observer',Slot:5b},{id:'minecraft:iron_ingot',Slot:6b},{id:'minecraft:hopper',Slot:7b},{id:'minecraft:iron_ingot',Slot:8b},{Slot:9b,tag:{ttb:{item:'vulcaanium'}},Count:1b}]} run function ttb:block/eckspei_locker/craft
# alchemy chamber
execute if score @s ttb_slot_count matches 9 if score @s ttb_slot_size matches ..64 if data storage ttb:temp block.tempest_crafter{input:[{id:'minecraft:iron_ingot',Slot:0b},{id:'minecraft:iron_ingot',Slot:1b},{id:'minecraft:iron_ingot',Slot:2b},{id:'minecraft:iron_ingot',Slot:3b},{id:'minecraft:cobblestone',Slot:4b},{id:'minecraft:blaze_rod',Slot:5b},{id:'minecraft:iron_ingot',Slot:6b},{id:'minecraft:iron_ingot',Slot:7b},{id:'minecraft:iron_ingot',Slot:8b},{Slot:9b,tag:{ttb:{item:'vulcaanium'}},Count:5b}]} run function ttb:block/alchemy_chamber/craft
# amethyst sunpad
execute if score @s ttb_slot_count matches 9 if score @s ttb_slot_size matches ..64 if data storage ttb:temp block.tempest_crafter{input:[{id:'minecraft:magenta_concrete',Slot:0b},{id:'minecraft:daylight_detector',Slot:1b},{id:'minecraft:magenta_concrete',Slot:2b},{id:'minecraft:magenta_concrete',Slot:3b},{tag:{ttb:{item:'amethyst'}},Slot:4b},{id:'minecraft:magenta_concrete',Slot:5b},{id:'minecraft:magenta_concrete',Slot:6b},{id:'minecraft:hopper',Slot:7b},{id:'minecraft:magenta_concrete',Slot:8b},{Slot:9b,tag:{ttb:{item:'vulcaanium'}},Count:4b}]} run function ttb:block/amethyst_sunpad/craft
