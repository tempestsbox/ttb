...
data modify block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input set from block ~ ~ ~ Items
data remove block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[{tag:{ttb:{gui_item:1b}}}]
data remove block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[{Slot:9b}]

execute store result score @s ttb_slot_count run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input

#get number of items from first array element
execute store result score first_stack_count ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[0].Count

#check if each slot with an item in it has the same stack size
execute if score @s ttb_slot_count matches 2.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[0].Count
...
execute if score @s ttb_slot_count matches 3.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[1].Count
...
execute if score @s ttb_slot_count matches 4.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[2].Count
...
execute if score @s ttb_slot_count matches 5.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[3].Count
...
execute if score @s ttb_slot_count matches 6.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[4].Count
...
execute if score @s ttb_slot_count matches 7.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[5].Count
...
execute if score @s ttb_slot_count matches 8.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[6].Count
...
execute if score @s ttb_slot_count matches 9.. store result score @s ttb_slot_size run data get block ~ ~ ~ Items[{Slot:1b}].tag.ttb.crafting.input[7].Count
