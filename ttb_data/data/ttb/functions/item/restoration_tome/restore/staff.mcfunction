...
setblock 29999984 254 29999984 black_shulker_box{Items:[{Slot:0b,id:barrier,Count:1b,tag:{CustomModelData:6830001}}]}
...
#post
loot replace block ~ ~ ~ container.16 1 mine 29999984 254 29999984 air{ttb:{shulker_box_loot:{drop_contents:1b}}}
