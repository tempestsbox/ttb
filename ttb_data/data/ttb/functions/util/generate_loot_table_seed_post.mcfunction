...
execute store result score #seed_pos_1 ttb_data run data get entity @s Pos[1]
...
scoreboard players operation #seed_pos_0 ttb_data -= #seed_pos_1 ttb_data
...
execute store result block ~ ~ ~ seed long 1 run scoreboard players get #seed_pos_0 ttb_data
